...
var AssembleProgramSchema = external_exports.object({
  ...
  path: external_exports.string().nonempty().optional(),
...
function assembleProgram({
  ...
  return new Promise((resolve, reject) => {
    ...
    const source = (0, import_path.join)(path, file);
    const output = (0, import_path.join)(path, `${name}.prg`);
    const map = (0, import_path.join)(path, `${name}.map`);
